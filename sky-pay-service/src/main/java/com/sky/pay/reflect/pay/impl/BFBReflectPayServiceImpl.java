 ...
 *
 *    Filename:    BFBReflectPayServiceImpl.java 
 *
...
/**
 *  * @ClassName BFBReflectPayServiceImpl
 *  * @Description TODO(这里用一句话描述这个类的作用)
 *  * @Author Hardy
 *  * @Date 2018年08月26日 18:49
 *  * @Version 1.0.0
 *  
 **/
public class BFBReflectPayServiceImpl implements ReflectPayService {
    @Override
